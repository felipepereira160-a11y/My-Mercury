...
if st.session_state.df_dados is not None:
    ...
    status_options = sorted(df_dados[status_col].dropna().unique()) if status_col else []
    status_selecionado = f_col1.multiselect("Filtrar por Status:", options=status_options)
    
    rep_options = sorted(df_dados[rep_col_dados].dropna().unique()) if rep_col_dados else []
